...
/**
 * Themaker_AbstractAction
**/
abstract class Themaker_AbstractAction
{
    public /*** XCube_Root ***/ $mRoot = null;

    public /*** Themaker_Module ***/ $mModule = null;

    public /*** Themaker_AssetManager ***/ $mAsset = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Themaker_{Tablename}Handler
    **/
    ...
    **/
    ...
    {
        return THEMAKER_FRAME_VIEW_NONE;
    }
