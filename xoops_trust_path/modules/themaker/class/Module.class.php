...
define('THEMAKER_FRAME_PERFORM_SUCCESS', 1);
define('THEMAKER_FRAME_PERFORM_FAIL', 2);
define('THEMAKER_FRAME_INIT_SUCCESS', 3);

define('THEMAKER_FRAME_VIEW_NONE','none');
define('THEMAKER_FRAME_VIEW_SUCCESS','success');
define('THEMAKER_FRAME_VIEW_ERROR','error');
define('THEMAKER_FRAME_VIEW_INDEX','index');
define('THEMAKER_FRAME_VIEW_INPUT','input');
define('THEMAKER_FRAME_VIEW_PREVIEW','preview');
define('THEMAKER_FRAME_VIEW_CANCEL','cancel');

/**
 * Themaker_Module
**/
class Themaker_Module extends Legacy_ModuleAdapter
{
    public /*** string ***/ $mActionName = null;

    public /*** Themaker_AbstractAction ***/ $mAction = null;

    public /*** bool ***/ $mAdminFlag = false;

    public /*** Themaker_AssetManager ***/ $mAssetManager = null;
    ...
    protected /*** Enum[] ***/ $_mAllowViewNames = array(
        THEMAKER_FRAME_VIEW_NONE,
        THEMAKER_FRAME_VIEW_SUCCESS,
        THEMAKER_FRAME_VIEW_ERROR,
        THEMAKER_FRAME_VIEW_INDEX,
        THEMAKER_FRAME_VIEW_INPUT,
        THEMAKER_FRAME_VIEW_PREVIEW,
        THEMAKER_FRAME_VIEW_CANCEL
    );
    ...
    **/
    public function startup()
    {
        ...
        XCube_DelegateUtils::call('Module.themaker.Global.Event.GetAssetManager',new XCube_Ref($this->mAssetManager),$this->mXoopsModule->get('dirname'));
    ...
    **/
    private function _getDefaultActionName()
    {
        ...
        $dataname = isset($dataname) ? $dataname : 'Setting';
    ...
    **/
    public function getRenderSystemName()
    {
        ...
        if(!defined('THEMAKER_ADMIN_RENDER_REGISTED'))
        {
            define('THEMAKER_ADMIN_RENDER_REGISTED',true);
            $root =& XCube_Root::getSingleton();
            $root->overrideSiteConfig(
                array(
                    'RenderSystems' => array(
                        'Themaker_AdminRenderSystem' => 'Themaker_AdminRenderSystem'
                    ),
                    'Themaker_AdminRenderSystem' => array(
                        'root' => THEMAKER_TRUST_PATH,
                        'path' => '/admin/class/ThemakerAdminRenderSystem.class.php',
                        'class' => 'Themaker_AdminRenderSystem'
                    )
                )
            );
        }

        return 'Themaker_AdminRenderSystem';
    }
    ...
    private function _createAction()
    {
        ...
        switch(true)
        {
            case file_exists(
                ...
                break;
            case file_exists(
                $path = THEMAKER_TRUST_PATH . '/' . $fileName
            ):
                break;
            default:
                return false;
        ...
        $className = 'Themaker_' . ($this->mAdminFlag ? 'Admin_' : '')
            . ucfirst($this->mActionName) . 'Action';
        if(class_exists($className))
        {
            $this->mAction = new $className();
        }
        if(!$this->mAction instanceof Themaker_AbstractAction)
        {
            return false;
        }
    ...
    **/
    ...
    {
        /**
         * Module.themaker.Global.Event.Exception.ActionNotFound
         *
         * @param    string    $dirname
         *
         * @return    void
        **/
        XCube_DelegateUtils::call('Module.themaker.Global.Event.Exception.ActionNotFound',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.themaker.Global.Event.Exception.Preparation
         *
         * @param    string    $dirname
         *
         * @return    void
        **/
        XCube_DelegateUtils::call('Module.themaker.Global.Event.Exception.Preparation',$this->mAssetManager->mDirname);
        /**
    ...
    **/
    ...
    {
        /**
         * Module.themaker.Global.Event.Exception.Permission
         *
         * @param    string    $dirname
         *
         * @return    void
        **/
        XCube_DelegateUtils::call('Module.themaker.Global.Event.Exception.Permission',$this->mAssetManager->mDirname);
        /**
        ...
        **/
        ...
        $root =& XCube_Root::getSingleton();
        $root->mController->executeRedirect(XOOPS_URL, 1, _MD_THEMAKER_ERROR_PERMISSION);
    }
}
