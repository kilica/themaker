...
/**
 * Themaker_AbstractViewAction
**/
abstract class Themaker_AbstractViewAction extends Themaker_AbstractAction
{
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_THEMAKER_ERROR_CONTENT_IS_NOT_FOUND);
    }
}
