...
/**
 * Themaker_AbstractEditAction
**/
abstract class Themaker_AbstractEditAction extends Themaker_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        return THEMAKER_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return THEMAKER_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_THEMAKER_ERROR_DBUPDATE_FAILED);
    }
