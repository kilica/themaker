...
/**
 * Themaker_AssetManager
**/
class Themaker_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'themaker';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Themaker_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Themaker_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return THEMAKER_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}
